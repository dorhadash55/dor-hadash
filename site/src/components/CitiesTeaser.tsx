  ...
  return (
    <section className="bg-white py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-12 flex gap-4 overflow-x-auto snap-x snap-mandatory pb-2 scrollbar-hide sm:grid sm:grid-cols-2 sm:gap-6 sm:overflow-visible sm:pb-0 lg:grid-cols-3">
          {cities.map((city) => (
            <Link
              key={city.slug}
              to={`/${city.slug}`}
              className="group relative w-[75%] shrink-0 snap-start overflow-hidden rounded-2xl shadow-sm transition-shadow hover:shadow-xl sm:w-auto sm:shrink"
            >
