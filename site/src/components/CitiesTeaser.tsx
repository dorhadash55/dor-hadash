      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal>
          <SectionHeading
            ...
            description="Six destinations adaptées aux olim francophones."
            action={
        ...
        <div className="mt-8 -mx-4 flex gap-3 overflow-x-auto snap-x snap-mandatory px-4 pb-2 scrollbar-hide sm:mx-0 sm:mt-14 sm:grid sm:grid-cols-2 sm:gap-5 sm:overflow-visible sm:px-0 sm:pb-0 lg:grid-cols-3">
          {cities.map((city, i) => (
            <Reveal
              key={city.slug}
              delay={i * 70}
            ...
            >
              ...
              >
                <div className={`w-full overflow-hidden ${i === 0 ? "aspect-[5/4] sm:aspect-[2/1]" : "aspect-[5/4] sm:aspect-[4/3]"}`}>
                  <CityImage
                    city={city}
                    variant="card"
                ...
                <div className="absolute inset-x-0 bottom-0 p-4 sm:p-6">
                  <h3 className="font-heading text-lg font-semibold text-white sm:text-2xl">{city.name}</h3>
